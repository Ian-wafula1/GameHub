			...
			<div className="m-5 flex flex-col gap-5 max-w-[550px] w-[80%] px-8 pt-5 self-center bg-[#ffffff33] text-white text-lg font-semibold backdrop-blur-[10px] rounded-3xl ">
				...
				<Formik
					...
					<Form className="flex flex-col gap-2  ">
						...
						<button className="my-5 border-2 border-white bg-gray-700 transition-colors rounded-3xl px-4 py-[.6rem] hover:bg-slate-900 w-[60%] min-w-[180px] shrink self-center" type="submit">
							Reset password
						</button>
					</Form>
				</Formik>
