			...
			<div className="text-white py-4 px-8 flex flex-col gap-4 md:grid md:grid-cols-[2fr,3fr] md:gap-x-[3rem]">
				...
				<div className="flex flex-col gap-5 ">
					<div className="flex gap-2 items-center">
						...
						<Modal
							className={'relative text-white p-5 bg-neutral-800 rounded-2xl w-[70%] h-[60%] fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'}
							isOpen={modalIsOpen.model1}
							onRequestClose={closeModal1}
							contentLabel="Add Friends">
											...
											? users
													...
													?.map((x) => (
														<>
															...
															<button className="bg-green-600 px-4 py-1 active:bg-opacity-75 text-sm rounded-md" onClick={() => addFriend(x)}>
																Add
															</button>
														</>
													))
