...
export default function SearchBar() {
	const { searchTerm, setSearchTerm, setGames, setTitle } = useContext(AppContext);
	...
	return (
		<form 
        className='flex items-center w-[44%] p-0 relative'
